...
driver_standings_df = race_results_df \
    .groupBy(col("race_year"),col("driver_name"), col("driver_nationality"),col("team")) \
...
final_df.write.format("parquet").mode("overwrite").save(f"{presentaion_folder_path}/driver_standings")